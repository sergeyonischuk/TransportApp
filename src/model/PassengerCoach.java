...
public class PassengerCoach extends Car {
	...
	public PassengerCoach(Comfortableness comfortableness) throws Exception {

		super(comfortableness);
		cargoCapacityWeight = 3000;
			...
			case PREMIUM:
				...
				break;
			case FREIGHT:
				throw new IllegalArgumentException("Passenger coach cant have value: " + Comfortableness.FREIGHT);
			}
	}
	...
	public String toString() {
		return "PassengerCoach [comfortableness=" + comfortableness + ", passengerSeats=" + passengerSeats
				+ ", cargoCapacityWeight=" + cargoCapacityWeight + "]";
	}
